...
# }
#####
def make_JSON_MME_omim(dict_json):
    ...
    ## 2018.02.07
    dict_results = make_search_results_MME_omim(phenotypes, genes, '100', '0', dict_EntrezID2EnsemblID)
...
#####
def make_search_results_MME_omim(phenotypes, genes, size_disease, size_casereport, dict_EntrezID2EnsemblID):
    dict_results = {}
    flg_casereport = 0
...
#####
def make_JSON_IRUD_omim(phenotypes, genes, size_disease, size_casereport):
    dict_results = {}
    flg_casereport = 0
